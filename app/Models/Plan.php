...
class Plan extends HortonModel
{
    ...
    public function getDurationAttribute(): int { return (int) ($this->attributes['duration_value'] ?? $this->attributes['duration'] ?? 0); }
    public function getCapacityAttribute(): int { return (int) ($this->attributes['capacity_value'] ?? $this->attributes['capacity'] ?? 0); }
